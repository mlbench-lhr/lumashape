                ...
                <div className="flex flex-wrap gap-3">
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="Allen Key / Hex Key">Allen Key / Hex Key</option>
                            ...
                            <option value="Indicator, Dial">Indicator, Dial</option>
                            <option value="Indicator, Test">Indicator, Test</option>
                            <option value="Level">Level</option>
                            <option value="Marker / Scribe">Marker / Scribe</option>
                            <option value="Measuring Tape">Measuring Tape</option>
                            <option value="Micrometer, Inside">Micrometer, Inside</option>
                            <option value="Micrometer, Outside">Micrometer, Outside</option>
                            <option value="Micrometer, Depth">Micrometer, Depth</option>
                            <option value="Pliers, Adjustable">Pliers, Adjustable</option>
                            <option value="Pliers, Needle Nose">Pliers, Needle Nose</option>
                            <option value="Pliers, Slip Joint">Pliers, Slip Joint</option>
                            <option value="Pliers, Wire Cutting">Pliers, Wire Cutting</option>
                            <option value="Punch, Center">Punch, Center</option>
                            <option value="Router Bit">Router Bit</option>
                            <option value="Saw, Hand">Saw, Hand</option>
                            <option value="Saw, Hole">Saw, Hole</option>
                            <option value="Screwdriver, Flat">Screwdriver, Flat</option>
                            <option value="Screwdriver, Phillips">Screwdriver, Phillips</option>
                            <option value="Socket">Socket</option>
                            <option value="Square, Combination">Square, Combination</option>
                            <option value="Square, Engineer">Square, Engineer</option>
                            <option value="Tap">Tap</option>
                            <option value="Torque Wrench">Torque Wrench</option>
                            <option value="Utility Knife">Utility Knife</option>
                            <option value="Vise Grip / Locking Pliers">Vise Grip / Locking Pliers</option>
                            <option value="Wrench, Adjustable">Wrench, Adjustable</option>
                            <option value="Wrench, Box">Wrench, Box</option>
                            <option value="Wrench, Combination">Wrench, Combination</option>
                            <option value="Wrench, Open End">Wrench, Open End</option>
                            <option value="Wrench, Ratcheting">Wrench, Ratcheting</option>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="Mac Tools">Mac Tools</option>
