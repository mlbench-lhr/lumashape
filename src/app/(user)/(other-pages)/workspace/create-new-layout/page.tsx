...
const CreateNewLayout = () => {
    ...
    useEffect(() => {
        const data = { layoutName, width, length, units, materialColor };
        sessionStorage.setItem('layoutForm', JSON.stringify(data));
    }, [layoutName, width, length, units, materialColor]);
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="mt-4">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-primary text-gray-900 border-gray-300"
                                    placeholder=""
                                />
                            </div>
                        </div>
